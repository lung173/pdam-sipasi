            ...
            {CATEGORY_OPTIONS.map((cat) => (
              <button
                ...
                className={`px-3 py-2 rounded-lg border text-xs font-medium transition-all text-center
                  ${form.category === cat
                    ? "border-blue-500 bg-blue-50 dark:bg-blue-900/20 text-blue-800 dark:text-blue-200 ring-1 ring-blue-300"
                    : "border-gray-200 dark:border-slate-700 text-gray-600 dark:text-slate-300 hover:border-gray-300 hover:bg-gray-50 dark:hover:bg-slate-800"
                  }
