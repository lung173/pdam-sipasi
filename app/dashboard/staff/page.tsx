    ...
    <div className="space-y-6">
      ...
      {menungguScan > 0 && (
        <div className="bg-cyan-50 dark:bg-cyan-900/20 border border-cyan-200 dark:border-cyan-800 rounded-xl p-4 flex items-start gap-3">
          <FileScan className="w-5 h-5 text-cyan-600 dark:text-cyan-400 shrink-0 mt-0.5" />
          <div className="flex-1">
      ...
      <div className="card">
        <div className="px-5 py-4 border-b border-gray-100 dark:border-slate-800 flex items-center justify-between">
          <h2 className="font-semibold text-gray-900 dark:text-white">Dokumen Terbaru</h2>
          <Link href="/dashboard/staff/dokumen" className="text-sm text-blue-600 dark:text-blue-400 hover:underline flex items-center gap-1">
