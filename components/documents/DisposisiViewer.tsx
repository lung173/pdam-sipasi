...
function InfoRow({
  ...
  return (
    <div className="flex items-start gap-1 px-3 py-2">
      <span className="text-sm font-semibold text-gray-600 dark:text-slate-400 shrink-0 w-28">{label}</span>
      <span className="text-sm text-gray-500 dark:text-slate-500 shrink-0">:</span>
      <span
        className={`text-sm text-gray-900 dark:text-slate-200 ml-1 ${mono ? "font-mono" : ""} ${
