              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="bg-gray-50 dark:bg-slate-800/50 border-b border-gray-200 dark:border-slate-700">
                    ...
                    <th className="text-left px-4 py-3 font-semibold text-gray-700 dark:text-slate-300">Kategori</th>
                ...
                <tbody className="divide-y divide-gray-100 dark:divide-slate-800">
                  {documents.map((doc) => (
                    <tr key={doc.id} className="hover:bg-gray-50 dark:hover:bg-slate-800/50 transition-colors">
                      ...
                      <td className="px-4 py-3">
                        <span className="text-xs bg-gray-100 dark:bg-slate-800 text-gray-700 dark:text-slate-300 px-2 py-0.5 rounded-full">
