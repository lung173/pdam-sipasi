    ...
    <div className="space-y-3">
      ...
      <div
        ...
        className={cn(
          ...
          dragging ? "border-blue-500 bg-blue-50 dark:bg-blue-900/20" : "border-gray-300 dark:border-slate-600 hover:border-blue-400 hover:bg-gray-50 dark:hover:bg-slate-800",
      ...
      >
        ...
        {done ? (
          <div className="flex flex-col items-center gap-2">
            ...
            <p className="text-sm text-green-700 dark:text-green-400 font-medium">File berhasil diupload!</p>
          </div>
        ) : selectedFile ? (
          <div className="flex flex-col items-center gap-2">
            <FileIcon className="w-10 h-10 text-blue-500" />
            <p className="text-sm font-medium text-gray-900 dark:text-slate-200 truncate max-w-[200px]">
              {selectedFile.name}
            </p>
          ...
          <div className="flex flex-col items-center gap-2">
            ...
            <p className="text-sm text-gray-700 dark:text-slate-300 font-medium">Klik atau drop file di sini</p>
            <p className="text-xs text-gray-400 dark:text-slate-500">PDF, JPG, PNG — Maks. {MAX_MB}MB</p>
          </div>
        )}
      </div>
